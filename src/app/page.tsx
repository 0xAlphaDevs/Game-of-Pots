      ...
      <div className="container mx-auto px-4 py-24">
        <div className="text-center space-y-6 max-w-3xl mx-auto">
          ...
          <p className="text-xl text-zinc-400">
            The first no-loss lottery powered by sUSDe rewards. Stake to earn,
            play to win, never lose your principal.
          </p>
          <Button
            size="lg"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-20">
          <Card className="bg-zinc-800/50 border-zinc-700">
            <CardContent className="p-6 text-center">
              <div className="text-3xl font-bold text-emerald-400">29.0%</div>
              <div className="text-zinc-400 mt-2">Current sUSDe APY</div>
            </CardContent>
          </Card>
          <Card className="bg-zinc-800/50 border-zinc-700">
            <CardContent className="p-6 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20">
          <div className="text-center p-6">
            ...
            <p className="text-zinc-400">
              Your principal is always safe and can be withdrawn at vault
              maturity
            </p>
          </div>
          <div className="text-center p-6">
